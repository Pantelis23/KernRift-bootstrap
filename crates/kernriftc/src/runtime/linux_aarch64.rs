...
const CODE: [u8; 632] = {
    ...
    c[0x08] = 0xE0; c[0x09] = 0x03; c[0x0A] = 0x40; c[0x0B] = 0xF9;
    // 0x0C: add x1, sp, #8 = 0x910023E1
    c[0x0C] = 0xE1; c[0x0D] = 0x23; c[0x0E] = 0x00; c[0x0F] = 0x91;
    // 0x10: add x2, x0, #1 = 0x91000402
    c[0x10] = 0x02; c[0x11] = 0x04; c[0x12] = 0x00; c[0x13] = 0x91;
    // 0x14: add x2, x1, x2, lsl #3 = 0x8B020C22
    c[0x14] = 0x22; c[0x15] = 0x0C; c[0x16] = 0x02; c[0x17] = 0x8B;
    // 0x18: adr x9, data_envp (0x260) = 0x10001249
    c[0x18] = 0x49; c[0x19] = 0x12; c[0x1A] = 0x00; c[0x1B] = 0x10;
    // 0x1C: str x2, [x9] = 0xF9000122
    c[0x1C] = 0x22; c[0x1D] = 0x01; c[0x1E] = 0x00; c[0x1F] = 0xF9;
    // 0x20: bl main (placeholder) = 0x94000000
    c[0x20] = 0x00; c[0x21] = 0x00; c[0x22] = 0x00; c[0x23] = 0x94;
    // 0x24: bl __kr_exit = 0x94000001
    c[0x24] = 0x01; c[0x25] = 0x00; c[0x26] = 0x00; c[0x27] = 0x94;

    // __kr_exit at 0x28
    // 0x28: mov x8, #94 = 0xD2800BC8
    c[0x28] = 0xC8; c[0x29] = 0x0B; c[0x2A] = 0x80; c[0x2B] = 0xD2;
    // 0x2C: svc #0 = 0xD4000001
    c[0x2C] = 0x01; c[0x2D] = 0x00; c[0x2E] = 0x00; c[0x2F] = 0xD4;

    // __kr_write at 0x30
    // 0x30: mov x8, #64 = 0xD2800808
    c[0x30] = 0x08; c[0x31] = 0x08; c[0x32] = 0x80; c[0x33] = 0xD2;
    // 0x34: svc #0 = 0xD4000001
    c[0x34] = 0x01; c[0x35] = 0x00; c[0x36] = 0x00; c[0x37] = 0xD4;
    // 0x38: ret = 0xD65F03C0
    ...
    c[0x48] = 0x43; c[0x49] = 0x04; c[0x4A] = 0x80; c[0x4B] = 0xD2;
    ...
    c[0x54] = 0xC8; c[0x55] = 0x1B; c[0x56] = 0x80; c[0x57] = 0xD2;
    // 0x58: svc #0 = 0xD4000001
    c[0x58] = 0x01; c[0x59] = 0x00; c[0x5A] = 0x00; c[0x5B] = 0xD4;
    // 0x5C: ret = 0xD65F03C0
    ...
    c[0x130] = 0x20; c[0x131] = 0x02; c[0x132] = 0x80; c[0x133] = 0xD2;
    // 0x134: mov x1, #0 = 0xD2800001
    c[0x134] = 0x01; c[0x135] = 0x00; c[0x136] = 0x80; c[0x137] = 0xD2;
    // 0x138: mov x2, #0 = 0xD2800002
    c[0x138] = 0x02; c[0x139] = 0x00; c[0x13A] = 0x80; c[0x13B] = 0xD2;
    // 0x13C: mov x3, #0 = 0xD2800003
    c[0x13C] = 0x03; c[0x13D] = 0x00; c[0x13E] = 0x80; c[0x13F] = 0xD2;
    // 0x140: mov x4, #0 = 0xD2800004
    c[0x140] = 0x04; c[0x141] = 0x00; c[0x142] = 0x80; c[0x143] = 0xD2;
    // 0x144: mov x8, #220 (__NR_clone) = 0xD2801B88
    c[0x144] = 0x88; c[0x145] = 0x1B; c[0x146] = 0x80; c[0x147] = 0xD2;
    // 0x148: svc #0 = 0xD4000001
    c[0x148] = 0x01; c[0x149] = 0x00; c[0x14A] = 0x00; c[0x14B] = 0xD4;
    // 0x14C: cbz x0, .child (0x198): offset=76, imm19=19
    //   = 0xB4000260
    c[0x14C] = 0x60; c[0x14D] = 0x02; c[0x14E] = 0x00; c[0x14F] = 0xB4;
    // Parent path:
    // 0x150: mov x20, x0 = 0xAA0003F4
    c[0x150] = 0xF4; c[0x151] = 0x03; c[0x152] = 0x00; c[0x153] = 0xAA;
    // 0x154: sub sp, sp, #16 = 0xD10043FF
    c[0x154] = 0xFF; c[0x155] = 0x43; c[0x156] = 0x00; c[0x157] = 0xD1;
    // 0x158: mov x0, x20 = 0xAA1403E0
    c[0x158] = 0xE0; c[0x159] = 0x03; c[0x15A] = 0x14; c[0x15B] = 0xAA;
    // 0x15C: mov x1, sp = add x1, sp, #0 = 0x910003E1
    c[0x15C] = 0xE1; c[0x15D] = 0x03; c[0x15E] = 0x00; c[0x15F] = 0x91;
    // 0x160: mov x2, #0 = 0xD2800002
    c[0x160] = 0x02; c[0x161] = 0x00; c[0x162] = 0x80; c[0x163] = 0xD2;
    // 0x164: mov x3, #0 = 0xD2800003
    c[0x164] = 0x03; c[0x165] = 0x00; c[0x166] = 0x80; c[0x167] = 0xD2;
    // 0x168: mov x8, #260 (__NR_wait4) = 0xD2802088
    c[0x168] = 0x88; c[0x169] = 0x20; c[0x16A] = 0x80; c[0x16B] = 0xD2;
    // 0x16C: svc #0 = 0xD4000001
    c[0x16C] = 0x01; c[0x16D] = 0x00; c[0x16E] = 0x00; c[0x16F] = 0xD4;
    // 0x170: ldr w0, [sp] = 0xB94003E0
    c[0x170] = 0xE0; c[0x171] = 0x03; c[0x172] = 0x40; c[0x173] = 0xB9;
    // 0x174: add sp, sp, #16 = 0x910043FF
    c[0x174] = 0xFF; c[0x175] = 0x43; c[0x176] = 0x00; c[0x177] = 0x91;
    // 0x178: tst w0, #0xFF = 0x72001C1F
    c[0x178] = 0x1F; c[0x179] = 0x1C; c[0x17A] = 0x00; c[0x17B] = 0x72;
    // 0x17C: b.ne .signal_death (0x188): offset=12, imm19=3
    //   = 0x54000061
    c[0x17C] = 0x61; c[0x17D] = 0x00; c[0x17E] = 0x00; c[0x17F] = 0x54;
    // 0x180: ubfx w0, w0, #8, #8 = ubfm w0, w0, #8, #15 = 0x53083C00
    c[0x180] = 0x00; c[0x181] = 0x3C; c[0x182] = 0x08; c[0x183] = 0x53;
    // 0x184: b .done (0x18C): offset=8, imm26=2
    //   = 0x14000002
    c[0x184] = 0x02; c[0x185] = 0x00; c[0x186] = 0x00; c[0x187] = 0x14;
    // .signal_death at 0x188
    // 0x188: mov w0, #1 = 0x52800020
    c[0x188] = 0x20; c[0x189] = 0x00; c[0x18A] = 0x80; c[0x18B] = 0x52;
    // .done at 0x18C
    // 0x18C: ldp x19, x20, [sp, #16] = 0xA94153F3
    c[0x18C] = 0xF3; c[0x18D] = 0x53; c[0x18E] = 0x41; c[0x18F] = 0xA9;
    // 0x190: ldp x29, x30, [sp], #32 = 0xA8C27BFD
    c[0x190] = 0xFD; c[0x191] = 0x7B; c[0x192] = 0xC2; c[0x193] = 0xA8;
    // 0x194: ret = 0xD65F03C0
    c[0x194] = 0xC0; c[0x195] = 0x03; c[0x196] = 0x5F; c[0x197] = 0xD6;
    // .child at 0x198
    // 0x198: adr x5, sh_path (0x250): offset=0xB8=184
    //   immlo=0, immhi=46 => 0x100005C5
    c[0x198] = 0xC5; c[0x199] = 0x05; c[0x19A] = 0x00; c[0x19B] = 0x10;
    // 0x19C: adr x6, dash_c (0x258): offset=0xBC=188
    //   immlo=0, immhi=47 => 0x100005E6
    c[0x19C] = 0xE6; c[0x19D] = 0x05; c[0x1A0] = 0x00; c[0x1A1] = 0x10;
    // WAIT - I made an indexing error! 0x19E and 0x19F are skipped!
    // Let me be more careful:
    c[0x19E] = 0x00; c[0x19F] = 0x10;
    ...
    // 0x1A0: sub sp, sp, #32 = 0xD10083FF
    c[0x1A0] = 0xFF; c[0x1A1] = 0x83; c[0x1A2] = 0x00; c[0x1A3] = 0xD1;
    // 0x1A4: str x5, [sp] = 0xF90003E5
    c[0x1A4] = 0xE5; c[0x1A5] = 0x03; c[0x1A6] = 0x00; c[0x1A7] = 0xF9;
    // 0x1A8: str x6, [sp, #8] = 0xF90007E6
    c[0x1A8] = 0xE6; c[0x1A9] = 0x07; c[0x1AA] = 0x00; c[0x1AB] = 0xF9;
    // 0x1AC: str x19, [sp, #16] = 0xF9000BF3
    c[0x1AC] = 0xF3; c[0x1AD] = 0x0B; c[0x1AE] = 0x00; c[0x1AF] = 0xF9;
    // 0x1B0: str xzr, [sp, #24] = 0xF9000FFF
    c[0x1B0] = 0xFF; c[0x1B1] = 0x0F; c[0x1B2] = 0x00; c[0x1B3] = 0xF9;
    // 0x1B4: mov x0, x5 = 0xAA0503E0
    c[0x1B4] = 0xE0; c[0x1B5] = 0x03; c[0x1B6] = 0x05; c[0x1B7] = 0xAA;
    // 0x1B8: mov x1, sp = 0x910003E1
    c[0x1B8] = 0xE1; c[0x1B9] = 0x03; c[0x1BA] = 0x00; c[0x1BB] = 0x91;
    // 0x1BC: adr x9, data_envp (0x260): offset=0xA4=164
    //   immlo=0, immhi=41 => 0x10000529
    c[0x1BC] = 0x29; c[0x1BD] = 0x05; c[0x1BE] = 0x00; c[0x1BF] = 0x10;
    // 0x1C0: ldr x2, [x9] = 0xF9400122
    c[0x1C0] = 0x22; c[0x1C1] = 0x01; c[0x1C2] = 0x40; c[0x1C3] = 0xF9;
    // 0x1C4: mov x8, #221 (__NR_execve) = 0xD2801BA8
    c[0x1C4] = 0xA8; c[0x1C5] = 0x1B; c[0x1C6] = 0x80; c[0x1C7] = 0xD2;
    // 0x1C8: svc #0 = 0xD4000001
    c[0x1C8] = 0x01; c[0x1C9] = 0x00; c[0x1CA] = 0x00; c[0x1CB] = 0xD4;
    // 0x1CC: mov x0, #127 = 0xD2800FE0
    c[0x1CC] = 0xE0; c[0x1CD] = 0x0F; c[0x1CE] = 0x80; c[0x1CF] = 0xD2;
    // 0x1D0: mov x8, #94 (__NR_exit_group) = 0xD2800BC8
    c[0x1D0] = 0xC8; c[0x1D1] = 0x0B; c[0x1D2] = 0x80; c[0x1D3] = 0xD2;
    // 0x1D4: svc #0 = 0xD4000001
    c[0x1D4] = 0x01; c[0x1D5] = 0x00; c[0x1D6] = 0x00; c[0x1D7] = 0xD4;

    // __kr_str_copy at 0x1D8
    // 0x1D8: mov x2, x0 (save dst) = 0xAA0003E2
    c[0x1D8] = 0xE2; c[0x1D9] = 0x03; c[0x1DA] = 0x00; c[0x1DB] = 0xAA;
    // .copy_loop at 0x1DC
    // 0x1DC: ldrb w3, [x1] = 0x39400023
    c[0x1DC] = 0x23; c[0x1DD] = 0x00; c[0x1DE] = 0x40; c[0x1DF] = 0x39;
    // 0x1E0: strb w3, [x0] = 0x39000003
    c[0x1E0] = 0x03; c[0x1E1] = 0x00; c[0x1E2] = 0x00; c[0x1E3] = 0x39;
    // 0x1E4: cbz w3, .copy_done (0x1F4): offset=16, imm19=4
    //   32-bit CBZ: 0x34000083
    c[0x1E4] = 0x83; c[0x1E5] = 0x00; c[0x1E6] = 0x00; c[0x1E7] = 0x34;
    // 0x1E8: add x0, x0, #1 = 0x91000400
    c[0x1E8] = 0x00; c[0x1E9] = 0x04; c[0x1EA] = 0x00; c[0x1EB] = 0x91;
    // 0x1EC: add x1, x1, #1 = 0x91000421
    c[0x1EC] = 0x21; c[0x1ED] = 0x04; c[0x1EE] = 0x00; c[0x1EF] = 0x91;
    // 0x1F0: b .copy_loop (0x1DC): offset=-20 = 0x17FFFFFB
    c[0x1F0] = 0xFB; c[0x1F1] = 0xFF; c[0x1F2] = 0xFF; c[0x1F3] = 0x17;
    // .copy_done at 0x1F4
    // 0x1F4: mov x0, x2 = 0xAA0203E0
    c[0x1F4] = 0xE0; c[0x1F5] = 0x03; c[0x1F6] = 0x02; c[0x1F7] = 0xAA;
    // 0x1F8: ret = 0xD65F03C0
    c[0x1F8] = 0xC0; c[0x1F9] = 0x03; c[0x1FA] = 0x5F; c[0x1FB] = 0xD6;

    // __kr_str_cat at 0x1FC
    // 0x1FC: mov x2, x0 (save dst) = 0xAA0003E2
    c[0x1FC] = 0xE2; c[0x1FD] = 0x03; c[0x1FE] = 0x00; c[0x1FF] = 0xAA;
    // .find_end at 0x200
    // 0x200: ldrb w3, [x0] = 0x39400003
    c[0x200] = 0x03; c[0x201] = 0x00; c[0x202] = 0x40; c[0x203] = 0x39;
    // 0x204: cbz w3, .cat_copy (0x210): offset=12, imm19=3
    //   = 0x34000063
    c[0x204] = 0x63; c[0x205] = 0x00; c[0x206] = 0x00; c[0x207] = 0x34;
    // 0x208: add x0, x0, #1 = 0x91000400
    c[0x208] = 0x00; c[0x209] = 0x04; c[0x20A] = 0x00; c[0x20B] = 0x91;
    // 0x20C: b .find_end (0x200): offset=-12 = 0x17FFFFFD
    c[0x20C] = 0xFD; c[0x20D] = 0xFF; c[0x20E] = 0xFF; c[0x20F] = 0x17;
    // .cat_copy at 0x210
    // 0x210: ldrb w3, [x1] = 0x39400023
    c[0x210] = 0x23; c[0x211] = 0x00; c[0x212] = 0x40; c[0x213] = 0x39;
    // 0x214: strb w3, [x0] = 0x39000003
    c[0x214] = 0x03; c[0x215] = 0x00; c[0x216] = 0x00; c[0x217] = 0x39;
    // 0x218: cbz w3, .cat_done (0x228): offset=16, imm19=4
    //   = 0x34000083
    c[0x218] = 0x83; c[0x219] = 0x00; c[0x21A] = 0x00; c[0x21B] = 0x34;
    // 0x21C: add x0, x0, #1 = 0x91000400
    c[0x21C] = 0x00; c[0x21D] = 0x04; c[0x21E] = 0x00; c[0x21F] = 0x91;
    // 0x220: add x1, x1, #1 = 0x91000421
    c[0x220] = 0x21; c[0x221] = 0x04; c[0x222] = 0x00; c[0x223] = 0x91;
    // 0x224: b .cat_copy (0x210): offset=-20 = 0x17FFFFFB
    c[0x224] = 0xFB; c[0x225] = 0xFF; c[0x226] = 0xFF; c[0x227] = 0x17;
    // .cat_done at 0x228
    // 0x228: mov x0, x2 = 0xAA0203E0
    c[0x228] = 0xE0; c[0x229] = 0x03; c[0x22A] = 0x02; c[0x22B] = 0xAA;
    // 0x22C: ret = 0xD65F03C0
    c[0x22C] = 0xC0; c[0x22D] = 0x03; c[0x22E] = 0x5F; c[0x22F] = 0xD6;

    // __kr_str_len at 0x230
    // 0x230: mov x1, #0 = 0xD2800001
    c[0x230] = 0x01; c[0x231] = 0x00; c[0x232] = 0x80; c[0x233] = 0xD2;
    // .len_loop at 0x234
    // 0x234: ldrb w2, [x0] = 0x39400002
    c[0x234] = 0x02; c[0x235] = 0x00; c[0x236] = 0x40; c[0x237] = 0x39;
    // 0x238: cbz w2, .len_done (0x248): offset=16, imm19=4
    //   = 0x34000082
    c[0x238] = 0x82; c[0x239] = 0x00; c[0x23A] = 0x00; c[0x23B] = 0x34;
    // 0x23C: add x0, x0, #1 = 0x91000400
    c[0x23C] = 0x00; c[0x23D] = 0x04; c[0x23E] = 0x00; c[0x23F] = 0x91;
    // 0x240: add x1, x1, #1 = 0x91000421
    c[0x240] = 0x21; c[0x241] = 0x04; c[0x242] = 0x00; c[0x243] = 0x91;
    // 0x244: b .len_loop (0x234): offset=-16 = 0x17FFFFFC
    c[0x244] = 0xFC; c[0x245] = 0xFF; c[0x246] = 0xFF; c[0x247] = 0x17;
    // .len_done at 0x248
    // 0x248: mov x0, x1 = 0xAA0103E0
    c[0x248] = 0xE0; c[0x249] = 0x03; c[0x24A] = 0x01; c[0x24B] = 0xAA;
    // 0x24C: ret = 0xD65F03C0
    c[0x24C] = 0xC0; c[0x24D] = 0x03; c[0x24E] = 0x5F; c[0x24F] = 0xD6;

    // Strings at 0x250
    // "/bin/sh\0"
    c[0x250] = 0x2F; c[0x251] = 0x62; c[0x252] = 0x69; c[0x253] = 0x6E;
    c[0x254] = 0x2F; c[0x255] = 0x73; c[0x256] = 0x68; c[0x257] = 0x00;
    // "-c\0"
    c[0x258] = 0x2D; c[0x259] = 0x63; c[0x25A] = 0x00;
    // Padding (5 bytes to align to 0x260)
    c[0x25B] = 0x00; c[0x25C] = 0x00; c[0x25D] = 0x00; c[0x25E] = 0x00;
    c[0x25F] = 0x00;
