...
const CODE: [u8; 320] = {
    ...
    c[0x00] = 0x48; c[0x01] = 0x83; c[0x02] = 0xEC; c[0x03] = 0x28;
    // 0x04: mov rax, [rip+0x12d] (iat_base at 0x138) = 48 8B 05 2D 01 00 00
    c[0x04] = 0x48; c[0x05] = 0x8B; c[0x06] = 0x05; c[0x07] = 0x2D;
    c[0x08] = 0x01; c[0x09] = 0x00; c[0x0A] = 0x00;
    // 0x0b: mov ecx, -11 (STD_OUTPUT_HANDLE) = B9 F5 FF FF FF
    c[0x0B] = 0xB9; c[0x0C] = 0xF5; c[0x0D] = 0xFF; c[0x0E] = 0xFF; c[0x0F] = 0xFF;
    // 0x10: call [rax] (GetStdHandle) = FF 10
    c[0x10] = 0xFF; c[0x11] = 0x10;
    // 0x12: mov [rip+0x117], rax (stdout_handle at 0x130) = 48 89 05 17 01 00 00
    c[0x12] = 0x48; c[0x13] = 0x89; c[0x14] = 0x05; c[0x15] = 0x17;
    c[0x16] = 0x01; c[0x17] = 0x00; c[0x18] = 0x00;
    // 0x19: call main (placeholder) = E8 00 00 00 00
    c[0x19] = 0xE8; c[0x1A] = 0x00; c[0x1B] = 0x00; c[0x1C] = 0x00; c[0x1D] = 0x00;
    // 0x1e: mov ecx, eax = 89 C1
    c[0x1E] = 0x89; c[0x1F] = 0xC1;

    // === __kr_exit at 0x20 ===
    // 0x20: mov rax, [rip+0x111] (iat_base at 0x138) = 48 8B 05 11 01 00 00
    c[0x20] = 0x48; c[0x21] = 0x8B; c[0x22] = 0x05; c[0x23] = 0x11;
    c[0x24] = 0x01; c[0x25] = 0x00; c[0x26] = 0x00;
    // 0x27: jmp [rax+0x10] (ExitProcess) = FF 60 10
    c[0x27] = 0xFF; c[0x28] = 0x60; c[0x29] = 0x10;
    ...
    c[0x2B] = 0x48; c[0x2C] = 0x83; c[0x2D] = 0xEC; c[0x2E] = 0x30;
    // 0x2f: mov rcx, [rip+0xfa] (stdout at 0x130) = 48 8B 0D FA 00 00 00
    c[0x2F] = 0x48; c[0x30] = 0x8B; c[0x31] = 0x0D; c[0x32] = 0xFA;
    c[0x33] = 0x00; c[0x34] = 0x00; c[0x35] = 0x00;
    ...
    // = 41 89 D0
    c[0x36] = 0x41; c[0x37] = 0x89; c[0x38] = 0xD0;
    // 0x39: mov rdx, rsi = 48 89 F2
    c[0x39] = 0x48; c[0x3A] = 0x89; c[0x3B] = 0xF2;
    // 0x3c: lea r9, [rsp+32] = 4C 8D 4C 24 20
    c[0x3C] = 0x4C; c[0x3D] = 0x8D; c[0x3E] = 0x4C; c[0x3F] = 0x24; c[0x40] = 0x20;
    // 0x41: mov qword [rsp+40], 0 = 48 C7 44 24 28 00 00 00 00
    // (lpOverlapped = NULL, 5th arg at [rsp+0x28] after shadow)
    c[0x41] = 0x48; c[0x42] = 0xC7; c[0x43] = 0x44; c[0x44] = 0x24;
    c[0x45] = 0x28; c[0x46] = 0x00; c[0x47] = 0x00; c[0x48] = 0x00; c[0x49] = 0x00;
    ...
    c[0x4A] = 0x48; c[0x4B] = 0x8B; c[0x4C] = 0x05; c[0x4D] = 0xE7;
    c[0x4E] = 0x00; c[0x4F] = 0x00; c[0x50] = 0x00;
    // 0x51: call [rax+8] (WriteFile) = FF 50 08
    c[0x51] = 0xFF; c[0x52] = 0x50; c[0x53] = 0x08;
    // 0x54: add rsp, 48 = 48 83 C4 30
    c[0x54] = 0x48; c[0x55] = 0x83; c[0x56] = 0xC4; c[0x57] = 0x30;
    // 0x58: pop rbx = 5B
    c[0x58] = 0x5B;
    ...
    c[0x5A] = 0x48; c[0x5B] = 0x83; c[0x5C] = 0xEC; c[0x5D] = 0x28;
    // 0x5e: xor ecx, ecx = 31 C9  (lpAddress = NULL)
    c[0x5E] = 0x31; c[0x5F] = 0xC9;
    // 0x60: mov rdx, rdi = 48 89 FA  (dwSize)
    c[0x60] = 0x48; c[0x61] = 0x89; c[0x62] = 0xFA;
    // 0x63: mov r8d, 0x3000 = 41 B8 00 30 00 00  (MEM_COMMIT|MEM_RESERVE)
    c[0x63] = 0x41; c[0x64] = 0xB8; c[0x65] = 0x00; c[0x66] = 0x30;
    c[0x67] = 0x00; c[0x68] = 0x00;
    // 0x69: mov r9d, 4 = 41 B9 04 00 00 00  (PAGE_READWRITE)
    c[0x69] = 0x41; c[0x6A] = 0xB9; c[0x6B] = 0x04; c[0x6C] = 0x00;
    c[0x6D] = 0x00; c[0x6E] = 0x00;
    // 0x6f: mov rax, [rip+disp] (iat_base): ends at 0x76, disp = 0x138-0x76 = 0xc2
    c[0x6F] = 0x48; c[0x70] = 0x8B; c[0x71] = 0x05; c[0x72] = 0xC2;
    c[0x73] = 0x00; c[0x74] = 0x00; c[0x75] = 0x00;
    // 0x76: call [rax+0x18] (VirtualAlloc) = FF 50 18
    c[0x76] = 0xFF; c[0x77] = 0x50; c[0x78] = 0x18;
    // 0x79: add rsp, 40 = 48 83 C4 28
    c[0x79] = 0x48; c[0x7A] = 0x83; c[0x7B] = 0xC4; c[0x7C] = 0x28;
    // 0x7d: ret = C3
    c[0x7D] = 0xC3;
    // mmap ends at 0x7e
    ...
    c[0x7E] = 0x48; c[0x7F] = 0x83; c[0x80] = 0xC7; c[0x81] = 0x0F;
    // 0x82: and rdi, -16 = 48 83 E7 F0
    c[0x82] = 0x48; c[0x83] = 0x83; c[0x84] = 0xE7; c[0x85] = 0xF0;
    // 0x86: mov rax, [rip+disp] (heap_remaining=0x128): ends at 0x8d, disp=0x128-0x8d=0x9b
    c[0x86] = 0x48; c[0x87] = 0x8B; c[0x88] = 0x05; c[0x89] = 0x9B;
    c[0x8A] = 0x00; c[0x8B] = 0x00; c[0x8C] = 0x00;
    // 0x8d: cmp rdi, rax = 48 39 C7
    c[0x8D] = 0x48; c[0x8E] = 0x39; c[0x8F] = 0xC7;
    ...
    c[0x90] = 0x76; c[0x91] = 0x1E;
    // 0x92: push rdi = 57
    c[0x92] = 0x57;
    // 0x93: mov edi, 0x400000 = BF 00 00 40 00
    c[0x93] = 0xBF; c[0x94] = 0x00; c[0x95] = 0x00; c[0x96] = 0x40; c[0x97] = 0x00;
    // 0x98: call __kr_mmap_alloc (at 0x5a): ends at 0x9d, disp = 0x5a-0x9d = -0x43
    c[0x98] = 0xE8; c[0x99] = 0xBD; c[0x9A] = 0xFF; c[0x9B] = 0xFF; c[0x9C] = 0xFF;
    // 0x9d: mov [rip+disp], rax (heap_ptr=0x120): ends at 0xa4, disp=0x120-0xa4=0x7c
    c[0x9D] = 0x48; c[0x9E] = 0x89; c[0x9F] = 0x05; c[0xA0] = 0x7C;
    c[0xA1] = 0x00; c[0xA2] = 0x00; c[0xA3] = 0x00;
    // 0xa4: mov qword [rip+disp], 0x400000 (heap_remaining=0x128):
    //   ends at 0xaf, disp=0x128-0xaf=0x79
    c[0xA4] = 0x48; c[0xA5] = 0xC7; c[0xA6] = 0x05; c[0xA7] = 0x79;
    c[0xA8] = 0x00; c[0xA9] = 0x00; c[0xAA] = 0x00;
    c[0xAB] = 0x00; c[0xAC] = 0x00; c[0xAD] = 0x40; c[0xAE] = 0x00;
    // 0xaf: pop rdi = 5F
    c[0xAF] = 0x5F;
    // .have_space at 0xb0:
    // 0xb0: mov rax, [rip+disp] (heap_ptr=0x120): ends at 0xb7, disp=0x120-0xb7=0x69
    c[0xB0] = 0x48; c[0xB1] = 0x8B; c[0xB2] = 0x05; c[0xB3] = 0x69;
    c[0xB4] = 0x00; c[0xB5] = 0x00; c[0xB6] = 0x00;
    // 0xb7: add [rip+disp], rdi (heap_ptr=0x120): ends at 0xbe, disp=0x120-0xbe=0x62
    c[0xB7] = 0x48; c[0xB8] = 0x01; c[0xB9] = 0x3D; c[0xBA] = 0x62;
    c[0xBB] = 0x00; c[0xBC] = 0x00; c[0xBD] = 0x00;
    // 0xbe: sub [rip+disp], rdi (heap_remaining=0x128): ends at 0xc5, disp=0x128-0xc5=0x63
    c[0xBE] = 0x48; c[0xBF] = 0x29; c[0xC0] = 0x3D; c[0xC1] = 0x63;
    c[0xC2] = 0x00; c[0xC3] = 0x00; c[0xC4] = 0x00;
    // 0xc5: ret = C3
    c[0xC5] = 0xC3;
    ...
    c[0xCA] = 0xB8; c[0xCB] = 0x01; c[0xCC] = 0x00; c[0xCD] = 0x00; c[0xCE] = 0x00;
    // ret = C3
    c[0xCF] = 0xC3;

    // === __kr_str_copy at 0xd0 ===
    // mov rax, rdi = 48 89 F8
    c[0xD0] = 0x48; c[0xD1] = 0x89; c[0xD2] = 0xF8;
    // .copy_loop:
    // movzx ecx, byte [rsi] = 0F B6 0E
    c[0xD3] = 0x0F; c[0xD4] = 0xB6; c[0xD5] = 0x0E;
    // mov [rdi], cl = 88 0F
    c[0xD6] = 0x88; c[0xD7] = 0x0F;
    // test cl, cl = 84 C9
    c[0xD8] = 0x84; c[0xD9] = 0xC9;
    // je .done (+0x08) = 74 08
    c[0xDA] = 0x74; c[0xDB] = 0x08;
    // inc rdi = 48 FF C7
    c[0xDC] = 0x48; c[0xDD] = 0xFF; c[0xDE] = 0xC7;
    // inc rsi = 48 FF C6
    c[0xDF] = 0x48; c[0xE0] = 0xFF; c[0xE1] = 0xC6;
    // jmp .copy_loop = EB EF
    c[0xE2] = 0xEB; c[0xE3] = 0xEF;
    // .done: ret = C3
    c[0xE4] = 0xC3;

    // === __kr_str_cat at 0xe5 ===
    // mov rax, rdi = 48 89 F8
    c[0xE5] = 0x48; c[0xE6] = 0x89; c[0xE7] = 0xF8;
    // .find_end: cmp byte [rdi], 0 = 80 3F 00
    c[0xE8] = 0x80; c[0xE9] = 0x3F; c[0xEA] = 0x00;
    // je .cat_copy (+0x05) = 74 05
    c[0xEB] = 0x74; c[0xEC] = 0x05;
    // inc rdi = 48 FF C7
    c[0xED] = 0x48; c[0xEE] = 0xFF; c[0xEF] = 0xC7;
    // jmp .find_end = EB F6
    c[0xF0] = 0xEB; c[0xF1] = 0xF6;
    // .cat_copy: movzx ecx, byte [rsi] = 0F B6 0E
    c[0xF2] = 0x0F; c[0xF3] = 0xB6; c[0xF4] = 0x0E;
    // mov [rdi], cl = 88 0F
    c[0xF5] = 0x88; c[0xF6] = 0x0F;
    // test cl, cl = 84 C9
    c[0xF7] = 0x84; c[0xF8] = 0xC9;
    // je .done (+0x08) = 74 08
    c[0xF9] = 0x74; c[0xFA] = 0x08;
    // inc rdi = 48 FF C7
    c[0xFB] = 0x48; c[0xFC] = 0xFF; c[0xFD] = 0xC7;
    // inc rsi = 48 FF C6
    c[0xFE] = 0x48; c[0xFF] = 0xFF; c[0x100] = 0xC6;
    // jmp .cat_copy = EB EF
    c[0x101] = 0xEB; c[0x102] = 0xEF;
    // .done: ret = C3
    c[0x103] = 0xC3;

    // === __kr_str_len at 0x104 ===
    // xor eax, eax = 31 C0
    c[0x104] = 0x31; c[0x105] = 0xC0;
    // .loop: cmp byte [rdi], 0 = 80 3F 00
    c[0x106] = 0x80; c[0x107] = 0x3F; c[0x108] = 0x00;
    // je .done (+0x08) = 74 08
    c[0x109] = 0x74; c[0x10A] = 0x08;
    // inc rdi = 48 FF C7
    c[0x10B] = 0x48; c[0x10C] = 0xFF; c[0x10D] = 0xC7;
    // inc rax = 48 FF C0
    c[0x10E] = 0x48; c[0x10F] = 0xFF; c[0x110] = 0xC0;
    // jmp .loop = EB F3
    c[0x111] = 0xEB; c[0x112] = 0xF3;
    // .done: ret = C3
    c[0x113] = 0xC3;

    // 0x114 .. 0x117: padding (4 bytes, NOP sled)
    c[0x114] = 0x90; c[0x115] = 0x90; c[0x116] = 0x90; c[0x117] = 0x90;
